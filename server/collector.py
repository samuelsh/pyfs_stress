...
class Collector:
    ...
    def run(self):
        while not self.stop_event.is_set():
            ...
            self.logger.info("Total file operations executed {0}".format(self.test_stats['total']))
            self.logger.info("Total file operations succeeded {0}".format(self.test_stats['success']['total']))
            self.logger.info("Total file operations failed {0}".format(self.test_stats['failed']['total']))
